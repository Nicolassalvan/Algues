"""
Created on Sun Jan  8 14:12:08 2023
...
def augmenter_taille(taille):
    ...
    """
    if taille == settings.TAILLE_1:
        return settings.TAILLE_2
    elif taille == settings.TAILLE_2:
        return settings.TAILLE_4
    elif taille == settings.TAILLE_4:
        return settings.TAILLE_8
...
def reproduire(population, box, i):
    ...
    if is_room_for_reprod(population, box, i):
        ...
        population.taille[i] = settings.TAILLE_1
        population.age[i] = 0
